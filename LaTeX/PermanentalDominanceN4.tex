...
The normalized permanental-dominance problem compares two ways of summing
permutation monomials of a positive-semidefinite matrix.  The permanent uses
every permutation with coefficient one.  A generalized matrix function uses
only a subgroup and weights its elements by an irreducible character.  The
claim is that, after division by the character degree, none of these weighted
sums exceeds the permanent.
